...
export default function WordCloudComponent({ filter, type }: WordCloudComponentProps) {
  ...
  const allWords: WordData[] = [
    ...
    { text: "bug", value: 18, sentiment: "negative" },
    { text: "slow", value: 16, sentiment: "negative" },
    { text: "amazing", value: 35, sentiment: "positive" },
    { text: "excellent", value: 33, sentiment: "positive" },
    { text: "terrible", value: 15, sentiment: "negative" },
  ]

  const filteredWords = filter === "all" ? allWords : allWords.filter((word) => word.sentiment === filter)
  ...
  return (
    <div className="space-y-4">
      <canvas ref={canvasRef} className="h-[400px] w-full border rounded" />
